...
-   The first number in the left list is `3`. It appears in the right list three times, so the similarity score increases by <code>3 * 3 = <i>9</i></code>.
-   The second number in the left list is `4`. It appears in the right list once, so the similarity score increases by <code>4 * 1 = <i>4</i></code>.
