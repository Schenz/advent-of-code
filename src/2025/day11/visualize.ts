// Advent of Code - Day 11 - Console Visualization
...
const main = async (): Promise<void> => {
    try {
        ...
        const input: string = fs.readFileSync('src/2025/day11/resources/input.txt', 'utf8');

        const instructions = input.trim().split(/\r?\n/);

        console.log('\n🎄 Advent of Code - Day 11 Visualization\n');
