// Advent of Code - Day 10 - Console Visualization
...
const main = async (): Promise<void> => {
    try {
        ...
        const input: string = fs.readFileSync('src/2025/day10/resources/input.txt', 'utf8');

        const instructions = input.trim().split(/\r?\n/);

        console.log('\n🎄 Advent of Code - Day 10 Visualization\n');
        ...
        if (partChoice.trim() === '1') {
            ...
            actualResult = await part2(instructions);
            console.log(`\n  Visualization Result: ${visualResult}`);
