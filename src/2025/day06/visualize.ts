// Advent of Code - Day 6 - Console Visualization
...
const main = async (): Promise<void> => {
    try {
        ...
        const input: string = fs.readFileSync('src/2025/day06/resources/input.txt', 'utf8');

        const instructions = input.trim().split(/\r?\n/);

        console.log('\n🎄 Advent of Code - Day 6 Visualization\n');
