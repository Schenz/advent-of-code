...
- `123` _ `45` _ `6` = _`33210`_
- `328` + `64` + `98` = _`490`_
- `51` _ `387` _ `215` = _`4243455`_
- `64` + `23` + `314` = _`401`_
...
- The second problem from the right is `175` _ `581` _ `32` = _`3253600`_
- The third problem from the right is `8` + `248` + `369` = _`625`_
- Finally, the leftmost problem is `356` _ `24` _ `1` = _`8544`_
