...
(async function() {
  try {
    ...
    console.log("Result", part1(parseMonkeys(input), 20, (frustration) => Math.floor(frustration / 3)));

    console.log("--- Part Two ---");
    console.log("Result", part2(parseMonkeys(input), 10000, (frustration) => frustration % parseMonkeys(input).reduce((a, b) => a * b.test, 1)));
